...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Product.class.getName() + ".suppliers", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Supplier.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Supplier.class.getName() + ".products", jcacheConfiguration);
